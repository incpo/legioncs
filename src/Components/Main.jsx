...
export default function Main() {
  ...
  return (
      <PageContainer info={
        ...
        <div className='absolute left-0 right-0 md:right-[50%] text-center bottom-[5%] opacity-20 p-2 md:p-4'><p className='text-white text-xs'>Legion не связан с VALVE, все средства идут на развитие проекта.</p></div>
        </>
      } imgClass='main'/>
  );
}

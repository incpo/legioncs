...
export default function Main() {
  ...
  return (
      <PageContainer info={
        ...
        <div className='text-center my-4 md:my-6 xl:text-left'><h1 className='text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-9xl font-black text-white flex justify-center xl:justify-start'>LEGI<div className='text-[#5217D1]'><Typewriter options={{loop: true}} onInit={(typewriter) =>{typewriter.typeString('ON').pauseFor(1800).deleteAll().typeString('OFF').pauseFor(1800).deleteAll().start()} }/></div></h1></div>
